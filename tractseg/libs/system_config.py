...
class SystemConfig:
    ...
    if os.environ.get("TRACTSEG_DATA_DIR") is not None:  # check if environment variable
        ...
        ##DATA_PATH = HOME
        # for 1.25mm
        # DATA_PATH = ['/data7/wanliu/Data/HCP_1.25mm_270',

        ##****without bootstrap****
        # DATA_PATH = ['/data7/wanliu/Data/HCP_1.25mm_270',
        #              '/data7/wanliu/Data/HCP_1.25mm_901k_18b0',
        #              '/data7/wanliu/Data/HCP_1.25mm_121k_18b0']

        ##****with bootstrap****Change in data loader for different ratioone******
        DATA_PATH = ['/data7/wanliu/Data_Residual_Bootstrap/HCP_1.27mm_270_bootstrap',
                     '/data7/wanliu/Data_Residual_Bootstrap/HCP_1.27mm_901k_bootstrap',
                     '/data7/wanliu/Data_Residual_Bootstrap/HCP_1.27mm_121k_bootstrap']


    if NETWORK_DRIVE is not None:
        EXP_PATH = join(NETWORK_DRIVE, "hcp_exp_nodes")
    else:
        EXP_PATH = join(HOME, "hcp_exp7")
