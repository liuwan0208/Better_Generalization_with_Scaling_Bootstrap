...
def main():
    ...
    parser.add_argument("-i", metavar="dir path", dest="input", default='/data7/wanliu/Data/HCP_initdata/HCP_1.25mm_270') # the path of the dmri data
